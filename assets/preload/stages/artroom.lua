...
sprite(-3099.8,-65,'bg',2,2,false)
spriteA(582.9,342,'couch',false,0)
sprite(111,44,'canvas',1,1,false)
...
sprite(-288.1,-74,'overlay',1,1,true)
...
addCharacterToList('naoto2', 'dad');
addCharacterToList('naga', 'bf');

end


function sprite(x,y,name,scalex,scaley,front)
